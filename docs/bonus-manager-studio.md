...
> **Stare:** reguli decise de Alex pe 14 sept. 2026. **Nimic implementat în aplicație.**
...
- **Ocuparea din septembrie** — se aplică și la manageri regula campaniei de reînscrieri, ca la
  instructori, sau se măsoară normal?
- **Bonusurile de vară** — nedefinite.

## 8. Ce trebuie construit înainte de prima plată
