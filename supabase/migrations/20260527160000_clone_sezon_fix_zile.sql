-- Fix: cursuri.zile e zi_saptamana[] (array), nu un singur element.
-- clone_sezon încerca să facă COALESCE pe varianta scalară.
-- Override-ul nu permite seta zile (rămâne mereu cel din sursă).
