-- Fix 20260729120000: sezonul se lua cu `min(e.sezon_id)`, dar `min(uuid)` nu
-- există în Postgres → RPC-ul eșua la primul apel. Luăm primul sezon non-null din
-- ședințele convertite. Restul funcției e neschimbat.
