-- Adaugă coloana `categorie` la view-ul raport_incasari ca să putem defalca
-- raportul pe zile și pe categorii (Abonament/Bilet/Merch/Taxa/Workshop/Auditie),
-- nu doar pe metodă de plată.
