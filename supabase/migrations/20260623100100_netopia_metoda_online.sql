-- Plățile Netopia se înregistrează cu metoda 'Online' (înainte hardcodat 'Card'), ca să fie
-- distincte de cardul dat la recepție pe POS. Restul corpului e identic cu migrația
-- 20260619150000_voucher_rezervare_wiring.sql.
