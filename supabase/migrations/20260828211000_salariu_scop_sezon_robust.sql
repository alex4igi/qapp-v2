-- Două găuri în felul în care `calculeaza_salariu_teacher` alege cursurile lunii,
-- descoperite pe 28 aug 2026 pornind de la o grupă lipsă din fișa Ioanei Perju.
--
-- 1. LUNA DINTRE SEZOANE → ZERO GRUPE. Sezonul lunii se alege după ziua 1. Vara 2026 se
--    termină pe 30 aug, iar Sezon 2026-2027 începe pe 12 sept: 1 septembrie 2026 nu cade
--    în niciun sezon, deci `v_sezon` iese NULL, `c.sezon = v_sezon` nu se potrivește
--    niciodată și salariul lunii septembrie ar fi ieșit gol pentru TOȚI instructorii
--    (verificat: preview septembrie = 0 grupe, total 0). Fallback: dacă niciun sezon nu
--    conține ziua 1, se ia sezonul care se suprapune cu luna, cel mai recent început.
--
-- 2. CURS ETICHETAT PE ALT SEZON DECÂT CEL ÎN CARE A FOST PREDAT. Dacă unui curs i se
--    schimbă sezonul din formular (s-a întâmplat cu 4 grupe de vară — vezi migrația
--    20260828210000), grupa dispare din salariul lunilor în care a fost efectiv predată,
--    tăcut. Plasă de siguranță: intră și cursurile de alt sezon care au prezențe în luna
--    calculată ȘI al căror sezon nu se suprapune deloc cu luna.
--
--    Condiția de nesuprapunere e esențială — ea păstrează comportamentul din
--    20260708190000 (o grupă o singură dată, fără clone din alte sezoane): în iunie 2026,
--    de pildă, cursurile din Vara 2026 au prezențe (sezonul începe pe 22 iunie), dar
--    sezonul lor SE suprapune cu luna, deci rămân excluse ca până acum. Clonele de sezon
--    viitor n-au prezențe în trecut, deci nu pot intra pe această ramură; verificat pe
--    date reale — pentru iulie și august ramura prinde exact cele 4 cursuri mutate din
--    greșeală și niciunul în plus.
--
-- Restul funcției (garda de acces, praguri, regula 90%, modelul per teacher) e neatins
-- față de 20260722220000.
