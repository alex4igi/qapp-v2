-- Corecție prag recurent: 25+ cursanți → 2000 lei (nu 2500). Restul benzilor și
-- toată logica (dual, regula 90%, facultativ) rămân ca în 20260708160000.
...
begin
  ...
  loop
    ...
    -- Sumă PER CLIENT (praguri recurent finale), cu ½ la 1 ședință/săpt
    ...
    -- Sumă PER PREZENȚE (praguri facultativ finale)
