-- `varsta` pe lista_cursuri: filtrul de grupă de vârstă din lista de cursuri.
-- (Tipul și ora rămân doar coloane — filtrele lor au fost scoase; vezi
-- 20260828130000 pentru ore_start/ora_start.)
