-- Qapp v2 — Overview trend: teacher self-scope robust (legacy + M:N).
--
-- Asignările teacher↔curs sunt în mare parte pe cursuri.teacher (FK legacy);
-- cursuri_teacheri (M:N) e sparse. Versiunea anterioară restrângea teacher-ul DOAR
-- prin cursuri_teacheri → un teacher real ar fi văzut zero cursuri. Adăugăm și
-- ramura legacy `c.teacher = current_teacher_id()`.
--
-- Singura schimbare vs 20260606150100 e clauza de scope teacher; restul identic.
